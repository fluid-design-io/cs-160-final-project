export const wikis = [
    {
        id: "Biodegradable",
        name: "Biodegradable",
        tagline: "Biodegradable products and materials quickly decompose into natural materials.",
        compound: "Typically, they're made from sustainable materials and plant by-products, such as cornstarch or sugarcane.",
        breakdowntime: "6-9 months",
        intowhat: "Natural elements, carbon dioxide, and water vapor by organisms like bacteria and fungi - which aren't harmful to the environment.",
        where: "Compost",
    ...
    },
    {
        id: "Recyclable",
        name: "Recyclable",
        tagline: "Recyclable products and materials can be reprocessed into raw material.",
        compound: "7 types of plastic",
        breakdowntime: "5 years to never",
        intowhat: "Other plastic packaged items, as long as the plastic being recycled meets purity standards and doesn't have hazardous contaminants.",
        where: "Recycle",
        ...
        nottodo: "You can only recycled plastic a few times, as recycled plastic may be of lower qualities.",
        label: "Recyclable products are labeled with a small triangle made of arrows. 7 categories of plastics known as resin numbers (yes, the numbers printed in the center of the triangle), the first category being the highest grade plastics, the seventh being a catch-all category that includes items like biodegradable products.",
